...
export const constantRouterMap = [
  ...
  // { path: '/goodspreview', component: _import('goods/goodspreview'), hidden: true },
  {
    path: '',
    component: Layout,
    redirect: 'dashboard',
  ...
  },
  {
    ...
    children: [
      { path: 'user', component: _import('user/user'), name: 'user', meta: { title: '会员列表', noCache: true }},
      { path: 'userlevel', component: _import('user/userlevel'), name: 'userlevel', meta: { title: '会员等级', noCache: true }},
      { path: 'address', component: _import('user/address'), name: 'address', meta: { title: '会员收货地址', noCache: true }}
...

  {
    ...
    children: [
      { path: 'classify', component: _import('goods/classify'), name: 'classify', meta: { title: '商品分类', noCache: true }},
      { path: 'goods', component: _import('goods/goods'), name: 'goods', meta: { title: '商品列表', noCache: true }},
      { path: 'attribute', component: _import('goods/attribute'), name: 'attribute', meta: { title: '商品属性', noCache: true }},
      { path: 'specification', component: _import('goods/specification'), name: 'specification', meta: { title: '首页商品设置', noCache: true }},
      // { path: 'goodspreview', component: _import('goods/goodspreview'), name: 'goodspreview', meta: { title: '商品预览', noCache: true }},
...

  {
    ...
    children: [
      { path: 'coupon', component: _import('coupon/coupon'), name: 'coupon', meta: { icon: 'chart', title: '优惠券列表', noCache: true }}
    ]
  },

  {
    ...
    children: [
      { path: 'order', component: _import('mall/order'), name: 'order', meta: { title: '订单列表', noCache: true }},
      { path: 'product', component: _import('goods/product'), name: 'product', meta: { title: '物流查询', noCache: true }}
      // { path: 'goods', component: _import('goods/goods'), name: 'goods', meta: { title: '商品列表', noCache: true }},
      // { path: 'specification', component: _import('goods/specification'), name: 'specification', meta: { title: '首页商品设置', noCache: true }},
      // { path: 'specification', component: _import('goods/specification'), name: 'specification', meta: { title: '商品规格', noCache: true }},
      // { path: 'product', component: _import('goods/product'), name: 'product', meta: { title: '货品管理', noCache: true }},
