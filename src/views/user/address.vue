...
<div class="app-container calendar-list-container">
  ...
  <div class="filter-container">
    ...
    <!-- <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入会员名称" v-model="listQuery.name">
      </el-input>
      <el-input clearable class="filter-item" style="width: 200px;" placeholder="请输入会员昵称" v-model="listQuery.status">
      </el-input> -->
  ...
  <el-table size="small" :data="list" v-loading="listLoading" element-loading-text="正在查询中。。。" border fit highlight-current-row>
    ...
    <el-table-column align="center" width="100px" label="会员id" prop="userId">
    </el-table-column>

    <!-- <el-table-column align="center" width="100px" label="会员名称" prop="name">
    </el-table-column> -->

    <el-table-column align="center" min-width="100px" label="收货人姓名" prop="name">
    </el-table-column>

    <el-table-column align="center" min-width="100px" label="收货人联系方式" prop="mobile">
    </el-table-column>

    <el-table-column align="center" min-width="100px" label="邮政编码" prop="postCode">
    </el-table-column>

    <el-table-column align="center" min-width="100px" label="省份" prop="provinceName">
    </el-table-column>

    <el-table-column align="center" min-width="100px" label="城市" prop="cityName">
    </el-table-column>

    <el-table-column align="center" min-width="100px" label="地区" prop="areaName">
    </el-table-column>

    <el-table-column align="center" min-width="100px" label="详细地址" prop="address">
    </el-table-column>
    ...
    <el-table-column align="center" min-width="80px" label="是否默认" prop="isDefault">
      <template slot-scope="scope">
          <!-- {{scope.row.isDefault === 1 ? '是' : '否'}} -->
          <el-tag :type="scope.row.isDefault ===1? 'success' : 'error' ">{{scope.row.isDefault === 1 ? '是' : '否'}}</el-tag>
        </template>
    </el-table-column>
